...
class CoingeckoGateway:
    def __init__(self):
        ...
        self.base_url = constants.COINGECKO_BASE_URL
        self.session.headers['Content-Type'] = 'Application/json'
        # self.session.headers['Authorization'] = constants.COINGECKO_API_KEY


    def make_api_call(self, endpoint:str, method:str,params:dict, payload:dict):
        LOGGER.debug("Initializing api call for Coingecko public api gateway")
        method = method.upper()
